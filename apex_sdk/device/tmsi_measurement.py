...
class TMSiMeasurement():
    ...
    def __init__(self, dev, name = "TMSi Measurement"):
        ...
        TMSiLoggerActivity().log("{}->>APEX-SDK: GET device channels request".format(self.get_name()))
        channels = self._dev.get_device_channels()
        TMSiLoggerActivity().log("APEX-SDK->>{}: GET device channels response".format(self.get_name()))
